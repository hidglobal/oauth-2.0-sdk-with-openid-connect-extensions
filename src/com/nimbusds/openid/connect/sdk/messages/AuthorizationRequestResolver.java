 ...
 * with a {@link com.nimbusds.openid.connect.sdk.util.JOSEObjectRetriever 
 * retriever} for remote JOSE objects and a 
...
public class AuthorizationRequestResolver {
	...
	private JOSEObject downloadRequestObject(final URL url)
		...
		try {
			...
			throw new ResolveException("Couldn't parse downloaded OpenID Connect request object: " + 
				                   e.getMessage(), e);
		}
	}
	...
	private JSONObject decodeRequestObject(final JOSEObject joseObject)
		...
		try {
			...
			throw new ResolveException("Couldn't decode/verify JOSE encoded OpenID Connect request object: " + 
				                   e.getMessage(), e);
		}
	...
	private static ResponseTypeSet resolveResponseTypeSet(final AuthorizationRequest request, 
		...
		if (JSONObjectUtils.containsKey(requestObject, "response_type")) {
			...
			try {
				...
				throw new ResolveException("Invalid \"response_type\" parameter in OpenID Connect request object: " + 
					                   e.getMessage(), e);
			}
	...
	private static Scope resolveScope(final AuthorizationRequest request,
		...
		if (JSONObjectUtils.containsKey(requestObject, "scope")) {
			...
			try {
				...
				throw new ResolveException("Invalid \"scope\" parameter in OpenID Connect request object: " + 
					                   e.getMessage(), e);
			}
	...
	private static ClientID resolveClientID(final AuthorizationRequest request,
		...
		if (JSONObjectUtils.containsKey(requestObject, "client_id")) {
			...
			try {
				...
				throw new ResolveException("Invalid \"client_id\" parameter in OpenID Connect request object: " + 
					                   e.getMessage(), e);
			}
	...
	private static URL resolveRedirectURI(final AuthorizationRequest request,
		...
		if (JSONObjectUtils.containsKey(requestObject, "redirect_uri")) {
			...
			try {
				...
				throw new ResolveException("Invalid \"redirect_uri\" parameter in OpenID Connect request object: " + 
					                   e.getMessage(), e);
			}
	...
	private static Nonce resolveNonce(final AuthorizationRequest request,
		...
		if (JSONObjectUtils.containsKey(requestObject, "nonce")) {
			...
			try {
				...
				throw new ResolveException("Invalid \"nonce\" parameter in OpenID Connect request object: " + 
					                   e.getMessage(), e);
			}
	...
	private static State resolveState(final AuthorizationRequest request,
		...
		if (JSONObjectUtils.containsKey(requestObject, "state")) {
			...
			try {
				...
				throw new ResolveException("Invalid \"state\" parameter in OpenID Connect request object: " + 
					                   e.getMessage(), e);
			}
	...
	private static Display resolveDisplay(final AuthorizationRequest request,
		...
		if (JSONObjectUtils.containsKey(requestObject, "display")) {
		       ...
		       try {
			       ...
			       throw new ResolveException("Invalid \"display\" parameter in OpenID Connect request object: " + 
			       	                          e.getMessage(), e);
		       }
	...
	private static Prompt resolvePrompt(final AuthorizationRequest request,
		...
		if (JSONObjectUtils.containsKey(requestObject, "prompt")) {
		       ...
		       try {
			       ...
			       throw new ResolveException("Invalid \"prompt\" parameter in OpenID Connect request object: " + 
			       	                          e.getMessage(), e);
		       }
	...
	private static JWT resolveIDTokenHint(final AuthorizationRequest request,
		...
		if (JSONObjectUtils.containsKey(requestObject, "id_token_hint")) {
			...
			try {
			       ...
			       throw new ResolveException("Invalid \"id_token_hint\" parameter in OpenID Connect request object: " + 
			       	                          e.getMessage(), e);
	...
	private static IDTokenClaimsRequest resolveIDTokenClaimsRequest(final ResponseTypeSet rts,
		...
		if (JSONObjectUtils.containsKey(requestObject, "id_token")) {
			...
			try {
				...
				throw new ResolveException("Invalid \"id_token\" member in OpenID Connect request object: " + 
					                   e.getMessage(), e);
			}
		}
	...
	private static UserInfoClaimsRequest resolveUserInfoClaimsRequest(final ResponseTypeSet rts,
		...
		if (JSONObjectUtils.containsKey(requestObject, "userinfo")) {
			...
			try {
				...
				throw new ResolveException("Invalid \"userinfo\" member in OpenID Connect request object: " + 
					                   e.getMessage(), e);
			}
		}
	...
	public ResolvedAuthorizationRequest resolve(final AuthorizationRequest request)
		...
		if (request.hasRequestObject()) {
			...
			if (request.getRequestObjectURI() != null) {
				...
				try {
					...
					throw new ResolveException(e.getMessage(), ErrorCode.INVALID_REQUEST_URI, 
						                   redirectURI, state, e);
				}
			}
			else {
			...
			try {
				...
				throw new ResolveException(e.getMessage(), ErrorCode.INVALID_OPENID_REQUEST_OBJECT,
					                   redirectURI, state, e);
			}
		}
		...
		try {
			...
			throw new ResolveException(e.getMessage(), ErrorCode.INVALID_REQUEST,
				                   redirectURI, state, e);
		}
