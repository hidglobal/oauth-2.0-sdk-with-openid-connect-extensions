 ...
 *
 * <ul>
 *     <li>{@link #getRequiredClaims The required claims} that the authorisation
 *         server must provide with the response.
 ...
 * 
 * <ul>
 *     <li>OpenID Connect Messages, section 2.1.2.1.
 * </ul>
 *
...
public abstract class ClaimsRequest {
	 ...
	 * OpenID Connect Messages 2.1.2.1.3.
	 */
