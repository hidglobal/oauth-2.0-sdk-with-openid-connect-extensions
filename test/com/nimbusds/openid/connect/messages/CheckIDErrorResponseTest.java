...
/**
 * Tests Check ID error response serialisation and parsing.
 *
 * @author Vladimir Dzhuvinov
 * @version 0.2 (2012-05-03)
 */
public class CheckIDErrorResponseTest extends TestCase {
	...
	public void testConstuctorMinimal() {
		...
		CheckIDErrorResponse r = new CheckIDErrorResponse(null, ErrorCode.INVALID_REQUEST, null);
		...
		try {
			r = CheckIDErrorResponse.parse(httpResponse);
	...
	public void testConstuctorFull() {
		...
		CheckIDErrorResponse r = new CheckIDErrorResponse(REALM, ErrorCode.INVALID_REQUEST, ERROR_PAGE_URL);
	...
	public void testConstructorForObservingLegalErrorCodes() {
		...
		new CheckIDErrorResponse(null, ErrorCode.INVALID_REQUEST, null);
		new CheckIDErrorResponse(null, ErrorCode.INVALID_TOKEN, null);
		new CheckIDErrorResponse(null, ErrorCode.INSUFFICIENT_SCOPE, null);
		
		try {
			new CheckIDErrorResponse(null, ErrorCode.INVALID_SCHEMA, null);
	...
	public void testLegalErrorCodesGetter() {
		...
		Set<ErrorCode> codes = CheckIDErrorResponse.getLegalErrorCodes();
