 ...
 * @version 0.9 (2012-05-03)
 */
public class CheckIDErrorResponse extends OAuthBearerTokenErrorResponse {


	/**
	 * Creates a new Check ID error response.
	 *
	 ...
	 *                                  error response.
	 */
	public CheckIDErrorResponse(final String realm, 
	...
	/**
	 * Parses a Check ID error response.
	 *
	 * @param httpResponse The HTTP response to parse. Must not be 
	 *                     {@code null}.
	 *
	 * @throws ParseException If the HTTP response cannot be parsed to a 
	 *                        valid Check ID error response.
	 */
	public static CheckIDErrorResponse parse(final HTTPResponse httpResponse)
		throws ParseException {
		
		OAuthBearerTokenErrorResponse r = OAuthBearerTokenErrorResponse.parse(httpResponse);
		
		return new CheckIDErrorResponse(r.getRealm(), r.getErrorCode(), r.getErrorURI());
	}
}
